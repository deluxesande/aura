                        ...
                        >
                            ...
                            <div className="p-6 space-y-5 relative z-10">
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <input
                                        className="w-full px-4 py-2.5 rounded-lg outline-none bg-slate-50 focus:bg-white border border-gray-200 focus:ring-2 focus:ring-green-500/20 focus:border-green-500 transition-all text-sm no-spinner"
