...
export default function ExpenseModal({
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast.error(error.response?.data?.error || "Failed to log expense");
        } finally {
            setIsSaving(false);
        }
    };
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full px-4 py-2.5 bg-slate-50 outline-none border border-gray-200 rounded-lg focus:ring-2 focus:ring-green-500/20 focus:border-green-500 text-sm transition-all no-spinner"
                                            placeholder="0.00"
                                        />
                                    </div>
                                </div>
