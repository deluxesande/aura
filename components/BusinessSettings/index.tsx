        ...
        <section className="relative bg-white p-6 rounded-lg shadow-md w-full">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <button
                    ...
                    className="mt-2 btn btn-md btn-ghost flex items-center bg-green-500 text-white hover:bg-green-600 w-full disabled:opacity-50 disabled:cursor-not-allowed"
                >
                    {hasExistingBusiness
                        ? "Update Business"
                        : "Create Business"}
