                    ...
                    <div>
                        ...
                        <div className="mt-1">
                            <input
                                ...
                                className="outline-none bg-gray-100 appearance-none block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 text-gray-500 cursor-not-allowed"
                            />
                        </div>
                    </div>
